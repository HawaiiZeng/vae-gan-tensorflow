...
from utils import CelebA, Syn

flags = tf.app.flags

# We choose 57 for debug purposes
...
flags.DEFINE_string("path", 'vae_gan_syn_data/', "for example, '/home/jack/data/' is the directory of your celebA data")
flags.DEFINE_integer("op", 0, "Training or Test")

FLAGS = flags.FLAGS
if __name__ == "__main__":

    root_log_dir = "./vaeganlogs/logs/syn"
    vaegan_checkpoint_dir = "./model_vaegan/model.ckpt"
    sample_path = "./vaeganSample/sample"

    mkdir_p(root_log_dir)
    mkdir_p('./model_vaegan_syn/')
    mkdir_p(sample_path)
